...
class sourcesep_net_distemplate_ff_dis_ff(sourcesep_net_dis_ff_dis_rnn): 
    def __init__(self, arguments, Krnn, Kdis, Linput):
        super(sourcesep_net_distemplate_ff_dis_ff, self).__init__(arguments, Krnn, Kdis, Linput)
